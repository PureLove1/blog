...
public class FastDfsClient {
    ...
    static {
        //从classpath下获取文件对象获取fastdfs配置文件路径
    ...
    public static boolean deleteFile(String fileUrl){
        ...
        String groupName = split1[1];
        String fileName = split1[2]+"/"+split1[3]+"/"+split1[4]+"/"+split1[5];
        System.out.println(groupName+":"+fileName);
        return deleteFile(groupName,fileName);
    }
    //根据组名获取组的信息
    ...
    public static void main(String[] args) {
        ...
        boolean b = deleteFile("http://43.143.129.55:8080/group1/M00/00/01/CgAIEWSUFj6AWQoOAACmb1EnXdU354.png");
